    ...
    <div className="container">
      ...
      {type === 'artist' && (
        <div>
          ...
          <div>
            Albums:
            {additionalMetaData && additionalMetaData.map((artistMetadata) => (
              <div className='artistsAlbumImageContainer'>
      ...
      {type === 'album' && (
        <div>
          ...
          <div>
            Songs list:
            {additionalMetaData && additionalMetaData.map((albumsMetadata) => (
              <p>{albumsMetadata.name} - {getDuration(albumsMetadata.duration)}</p>
            ))}
          </div>
        </div>
      )}
